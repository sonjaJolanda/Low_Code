...
\begin{document}
	...
	%Moderne Low Code Entwicklungsplattformen können nicht nur Code generieren, sondern die erstellten Softwaresysteme auch auf skalierbaren Cloud-basierten Infrastrukturen bereitstellen und sie den Nutzern weltweit über webbasierte Schnittstellen sofort zugänglich machen. Dies kann den Zeit- und Arbeitsaufwand für die Freigabe von Anwendungen (und Updates) für Nutzer drastisch verkürzen und die Attraktivität von LCDPs als Medium für die schnelle Anwendungsentwicklung und -bereitstellung erhöhen \autocite{DiRuscio.2022}.
	...
	% wie kann ich sagen dass das jetzt bedeutet das LCDPs Zukunft haben???
	...
	%Ich brauche so ca noch 60 Wörter mehr haha
